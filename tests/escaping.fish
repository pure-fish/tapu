...
@test "unescaped hash in description" (
    printf "TAP version 14\nok 1 - hello # world\n1..1\n" | tap_reporter 2>&1 | grep -q "hello # world"
    echo $status
) -eq 0
